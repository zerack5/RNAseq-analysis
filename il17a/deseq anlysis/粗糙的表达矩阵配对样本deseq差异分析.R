...
kname1 <- "all_diff12_paired_res.csv"
kname12 <- "all_diffsig12_paired_res.csv"
kname12up <- "all_diffsig12_paired_res_up.csv"
kname12down <- "all_diffsig12_paired_res_down.csv"
